...
class Trainer:
    ...
    def _optimizer_to(self, device):
        ...
        https://github.com/atomistic-machine-learning/SchNet4AIM/issues/126
    ...
    def train(self, device, n_epochs=sys.maxsize):
        ...
        try:
            print(" # Start the training of the SchNet models ")
            for _ in range(n_epochs):
                self.epoch += 1
                # Print some information about the progress of the training procedure
                ...
                contador=0                                 
                # Train the models
                # Iterate over all instances in the training dataset
                ...
                # Validate the models (check performance)
                # Iterate over all instances in the validation dataset
                self._model.eval()
                ...
                if self._stop:
                    break
            # Training Ends
            print(" # Successful termination of training procedure.")
            #
