...
import time
import numpy as np
from SchNet4AIM.train.hooks import Hook
...
class LoggingHook(Hook):
    ...
    Args:
        ...
        metrics (list): metrics to log; each metric has to be a subclass of s4aim.Metric.
    ...
    def on_epoch_begin(self, trainer):
        ...
        Args:
            trainer (Trainer): instance of SchNet4AIM.train.trainer.Trainer class.
